...
class StackedMNISTData:
    ...
    def __init__(self, mode: DataMode, default_batch_size: np.int32 = 256) -> None:
    ...
    def _prepare_data_set(self, training: bool = True) -> tuple:
        ...
        if self.channels > 1:
            ...
            generated_labels = np.zeros(shape=(images.shape[0],), dtype=np.int32)
    ...
    def get_random_batch(
        self, training: bool = True, batch_size: np.int32 = None
    ) -> tuple:
        """
